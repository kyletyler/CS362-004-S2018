/* Unit tests for vilage card
 * 
 * Description:
 *  Draws 1 card and adds 2 action
 * 
 * Operations:
 *  drawCard()
 *  discardCard()
 ...
 *  Actions in current state are incremented by 2
...
int main() {
    ...
    //////////////////////////////////////////
    // TEST 3: Actions are incremented by 2 //
    //////////////////////////////////////////
    ...
    printf("actions count = %d, expected = %d\t", test_G.numActions, G.numActions + 2);
    if(test_G.numActions == G.numActions + 2) 
        printf("village test: PASS\n");
    else
        printf("village test: FAIL\n");
